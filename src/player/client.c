...
InitClientPersistant(gclient_t *client)
{
	...
	if (sv_custom_settings->value)
	{
		...
		client->pers.max_prox = cs_player_ammo_prox->value; //50
		client->pers.max_tesla = cs_player_ammo_tesla->value; //50
		client->pers.max_flechettes = cs_player_ammo_flechettes->value; //200
		client->pers.max_rounds = cs_player_ammo_rounds->value; //100
	}
